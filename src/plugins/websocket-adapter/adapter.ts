...
import { serializeOutgoingMessage, serializePermissionRequest, serializeRpcNotification } from './event-serializer.js';
...
export class WebSocketAdapter implements IChannelAdapter {
  ...
  async sendNotification(notification: NotificationMessage): Promise<void> {
    ...
    this.connectionManager.broadcast(notification.sessionId, serializeRpcNotification('session/notification', notification));
  }
